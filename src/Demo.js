...
class Demo extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <Container>
        <Paper style={{ backgroundColor: "lightyellow", marginTop: "10px" }}>
          <Row>
            <Col> {this.renderSidebar()}</Col>
            <Col>
              <Scheduler
    ...
    return (
      <div className="demo-app-sidebar">
        <div className="demo-app-sidebar-section">
          <h5>Employees related details : </h5>
          <br />
          <br />
          <hr />
          <ul>
            <li>
              Double click on any dates and you will be prompted to create a new
              event
            </li>
        ...
        <div className="demo-app-sidebar-section">
          <h5> All Events ({this.state.data.length})</h5>
